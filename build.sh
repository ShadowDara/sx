...
zig c++ -g -std=c++20 -O0 tools/sx-multi_main.cpp src/sx-multi.cpp -o sx-multi.exe
...
zig c++ -std=c++20 -O3 tools/sx-multi_main.cpp src/sx-multi.cpp -o sx-multi_release.exe
